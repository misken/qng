...
------------
    ...
    │
    ├── setup.py           <- makes project pip installable (pip install -e .) so qng can be imported
    ├── src                <- Source code for use in this project.
    │   ├── qng <- Main package folder
    │   │   └── __init__.py    <- Marks as package
    │   │   └── qng.py  <- Just some placeholder Python source code file
    │
